...
Note: The system default Python version need to be 3.2+ for this method to work out. Especially macOS users will experience HTTP 403 error due to system default version of 2.7.
