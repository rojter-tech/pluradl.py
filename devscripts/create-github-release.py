...
class GitHubReleaser(object):
    _API_URL = 'https://api.github.com/repos/ytdl-org/plura-dl/releases'
    _UPLOADS_URL = 'https://uploads.github.com/repos/ytdl-org/plura-dl/releases/%s/assets?name=%s'
...
def main():
    ...
    new_release = releaser.create_release(
        version, name='plura-dl %s' % version, body=body)
