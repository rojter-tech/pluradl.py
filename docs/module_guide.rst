Using the ``plura_dl`` module
===============================

When using the ``plura_dl`` module, you start by creating an instance of :class:`PluraDL` and adding all the available extractors:
...
You use the :meth:`PluraDL.extract_info` method for getting the video information, which returns a dictionary:
