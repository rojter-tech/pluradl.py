...
from .PluraDL import PluraDL


def _real_main(argv=None):
    # Compatibility fixes for Windows
    if sys.platform == 'win32':
        # https://github.com/ytdl-org/plura-dl/issues/820
        codecs.register(lambda name: codecs.lookup('utf-8') if name == 'cp65001' else None)

    workaround_optparse_bug9161()

    setproctitle('plura-dl')
    ...
    with PluraDL(ydl_opts) as ydl:
        ...
        if (len(all_urls) < 1) and (opts.load_info_filename is None):
            ...
            parser.error(
                ...
                'Type plura-dl --help to see a list of all options.')
...
__all__ = ['main', 'PluraDL', 'gen_extractors', 'list_extractors']
