...
try:
    ...
    # is apparently broken (see https://github.com/ytdl-org/plura-dl/pull/6244)
...
if platform.python_implementation() == 'PyPy' and sys.pypy_version_info < (5, 4, 0):
    ...
    # names, see the original PyPy issue [1] and the plura-dl one [2].
    # 1. https://bitbucket.org/pypy/pypy/issues/2360/windows-ctypescdll-typeerror-function-name
    # 2. https://github.com/ytdl-org/plura-dl/pull/4392
