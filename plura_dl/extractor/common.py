...
class InfoExtractor(object):
    ...
    passed to the PluraDL. The PluraDL processes this
    ...
    webpage_url:    The URL to the video webpage, if given to plura-dl it
                    should allow to get the same result again. (It will be set
                    by PluraDL if it's missing)
    ...
    def _extract_f4m_formats(self, manifest_url, video_id, preference=None, f4m_id=None,
        ...
        manifest = self._download_xml(
            ...
            # (see https://github.com/ytdl-org/plura-dl/issues/6215#issuecomment-121704244)
    ...
    def _parse_f4m_formats(self, manifest, manifest_url, video_id, preference=None, f4m_id=None,
        ...
        # currently plura-dl cannot decode the playerVerificationChallenge as Akamai uses Adobe Alchemy
        ...
        # rendition (see https://github.com/ytdl-org/plura-dl/issues/8573).
    ...
    def _parse_m3u8_formats(self, m3u8_doc, m3u8_url, ext=None,
        ...
        # 2. https://github.com/ytdl-org/plura-dl/issues/12211
        # 3. https://github.com/ytdl-org/plura-dl/issues/18923
                ...
                for representation in adaptation_set.findall(_add_ns('Representation')):
                    ...
                    if content_type == 'text':
                        ...
                        def prepare_template(template_name, identifiers):
                            ...
                            # https://github.com/ytdl-org/plura-dl/issues/16867).
                            t = ''
                            in_template = False
                            for c in tmpl:
                                t += c
                        ...
                        # https://github.com/ytdl-org/plura-dl/issues/11605)
                        ...
                        if 'segment_urls' not in representation_ms_info and 'media' in representation_ms_info:
                            ...
                            # https://github.com/ytdl-org/plura-dl/pull/14844
                            fragments = []
                        ...
                        # of such manifests (see https://github.com/ytdl-org/plura-dl/issues/15111,
                        # https://github.com/ytdl-org/plura-dl/issues/13919)
    ...
    def _parse_html5_media_entries(self, base_url, webpage, video_id, m3u8_id=None, m3u8_entry_protocol='m3u8', mpd_id=None, preference=None):
        ...
        media_tags.extend(re.findall(
            ...
            # https://github.com/ytdl-org/plura-dl/issues/11979, example URL:
    ...
    def _apply_first_set_cookie_header(self, url_handle, cookie):
        ...
        1. https://new.vk.com/
        2. https://github.com/ytdl-org/plura-dl/issues/9841#issuecomment-227871201
