...
class GenericIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        # RSS feed
        {
            'url': 'http://phihag.de/2014/plura-dl/rss2.xml',
            'info_dict': {
                'id': 'http://phihag.de/2014/plura-dl/rss2.xml',
        ...
        {
            # https://github.com/ytdl-org/plura-dl/issues/2253
        ...
        {
            # https://github.com/ytdl-org/plura-dl/issues/3541
            'add_ie': ['BrightcoveLegacy'],
        ...
        # https://github.com/ytdl-org/plura-dl/issues/2283
        {
        ...
        {
            # vshare embed
            'url': 'https://plura-dl-demo.neocities.org/vshare.html',
    ...
    def _real_extract(self, url):
        ...
        if not parsed_url.scheme:
                    ...
                    if default_search == 'auto_warning':
                        if re.match(r'^(?:url|URL)$', url):
                            raise ExtractorError(
                                'Invalid URL:  %r . Call plura-dl like this:  plura-dl -v "https://www.youtube.com/watch?v=BaW_jenozKc"  ' % url,
                                expected=True)
                        else:
            ...
            if default_search in ('error', 'fixup_error'):
                raise ExtractorError(
                    ...
                    'Set --default-search "ytsearch" (or run  plura-dl "ytsearch:%s" ) to search YouTube'
        ...
        if not full_response:
            ...
            # test whether it's HTML or not). According to plura-dl default Accept-Encoding
        ...
        # (e.g. https://github.com/ytdl-org/plura-dl/issues/2448)
        # Unescaping the whole page allows to handle those cases in a generic way
        webpage = compat_urllib_parse_unquote(webpage)

        # Unescape squarespace embeds to be detected by generic extractor,
        # see https://github.com/ytdl-org/plura-dl/issues/21294
        webpage = re.sub(
        ...
        if jwplayer_data:
            try:
                ...
                # See https://github.com/ytdl-org/plura-dl/pull/16735
                pass
        ...
        if not found:
            ...
            # be supported by plura-dl thus this is checked the very last (see
            # https://dev.twitter.com/cards/types/player#On_twitter.com_via_desktop_browser)
