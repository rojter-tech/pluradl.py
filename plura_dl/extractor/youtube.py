...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [
        ...
        # Extraction from multiple DASH manifests (https://github.com/ytdl-org/plura-dl/pull/6097)
        {
    ...
    def _real_extract(self, url):
        ...
        if 'conn' in video_info and video_info['conn'][0].startswith('rtmp'):
            ...
            for fmt in streaming_formats:
                ...
                # lack metadata (see https://github.com/ytdl-org/plura-dl/pull/5993).
...
class YoutubeSearchURLIE(YoutubeSearchBaseInfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://www.youtube.com/results?baz=bar&search_query=plura-dl+test+video&filters=video&lclk=video',
        'playlist_mincount': 5,
        'info_dict': {
            'title': 'plura-dl test video',
        }
    }, {
...
class YoutubeTruncatedURLIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        raise ExtractorError(
            ...
            ' or simply  plura-dl BaW_jenozKc  .',
            expected=True)
