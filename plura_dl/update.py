...
def update_self(to_screen, verbose, opener):
    ...
    UPDATE_URL = 'https://github.com/rojter-tech/pluradl.py/wiki/'
    VERSION_URL = UPDATE_URL + 'LATEST_VERSION'
    JSON_URL = UPDATE_URL + 'versions.json'
    UPDATES_RSA_KEY = (, 65537)

    if not isinstance(globals().get('__loader__'), zipimporter) and not hasattr(sys, 'frozen'):
        to_screen('It looks like you installed plura-dl with a package manager, pip, setup.py or a tarball. Please use that to update.')
        return
    ...
    if newversion == __version__:
        to_screen('plura-dl is up-to-date (' + __version__ + ')')
        return
    ...
    if version_tuple(__version__) >= version_tuple(version_id):
        to_screen('plura-dl is up to date (%s)' % __version__)
        return
    ...
    if hasattr(sys, 'frozen'):
        ...
        try:
            bat = os.path.join(directory, 'plura-dl-updater.bat')
...
move /Y "%s.new" "%s" > NUL
echo Updated plura-dl to version %s.
start /b "" cmd /c del "%%~f0"&exit /b"
    ...
    to_screen('Updated plura-dl. Restart plura-dl to use the new version.')
