...
from plura_dl.compat import compat_http_server, compat_urllib_request
import ssl
import threading
...
class TestHTTPS(unittest.TestCase):
    ...
    def test_nocheckcertificate(self):
        ...
        ydl = PluraDL({'logger': FakeLogger(), 'nocheckcertificate': True})
